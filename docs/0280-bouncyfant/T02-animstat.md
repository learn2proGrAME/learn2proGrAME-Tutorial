...
1. Es wird ein Animations-Controller erstellt. Gib diesem einen sinnvollen Namen wie z.B. Elefant_AnimationsController
![AnimCtrl umbenennen](img/T02/T02-c-AnimationsController.png)
<!-- korrektes Bild? leicht anderes in google docs -->

2. In der Hierarchy wird ein neues Gameobject erstellt. Mit diesem Objekt ist auch der automatisch erstellte AnimationsController verknüpft. Der *AnimationsController* ist ein *Controller*, das heißt dieser steuert die Animation der Spielfigur, z.B. damit der Elefant geht, wenn man ihn bewegt.
![Animation speichern](img/T02/T02-c-Animator Zuweisung.png)
...
![Transition settings](img/T02/T02-j-Einstellungen Übergänge.png)
